...
.kpi-card { background: #3A3A3A; border-radius: 10px; padding: 16px 1px; text-align: center; border: 1px solid #505050; height: 110px; display: flex; flex-direction: column; justify-content: center; }
