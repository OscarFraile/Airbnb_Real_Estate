...
.kpi-card { background: #3A3A3A; border-radius: 10px; padding: 16px 1px; text-align: center; border: 1px solid #505050; height: 140px; display: flex; flex-direction: column; justify-content: center; }
.kpi-lbl { font-size: 11px; color: #888888; margin: 0 0 4px 0; text-transform: uppercase; letter-spacing: 0.05em; }
.kpi-val { font-size: 36px !important; font-weight: 700; color: #FF385C; margin: 0; line-height: 1.1; }
